...
import { FaHome, FaCube, FaColumns, FaMicrophone, FaShapes, 
         FaCalculator, FaRuler, FaKey, FaMouse, FaList, 
         FaShoppingCart, FaRandom, FaBars, FaWpforms } from "react-icons/fa";
...
const exerciseItems: SidebarItem[] = [
  ...
  { label: "Carrito de Compras", route: "/shopcart", icon: <FaShoppingCart /> },
  { label: "Generador de Números Aleatorios", route: "/randomnum", icon: <FaRandom /> },
  { label: "Encuesta de Satisfacción", route: "/encuesta", icon: <FaBars /> },
  { label: "Formulario de Registro", route: "/formularioreg", icon: <FaWpforms /> },
];
