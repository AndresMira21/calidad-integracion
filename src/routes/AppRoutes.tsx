...
import RandomNum from "../views/RandomNum";
import Encuesta from "../views/Encuenta";
import FormularioReg from "../views/FormularioReg";
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="formularioreg" element={<FormularioReg />} />
      </Route>
    </Routes>
  );
}